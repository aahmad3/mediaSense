...
def generate_data():
    ...
    cons_key = "IN7KpxMkULBBfet28OZgUJZFi"
    #cons_key_secret = input('Enter the Consumer Secret Key: ')
    cons_key_secret = "9ABVO0SR2DQ3S4wKO7CJerKMHD0vZooFrHdC31kb07QJPd1Qun"
    #acc_token = input('Enter the Access Token: ')
    acc_token = "1329738112684023809-me4xdG0UN5uKZSawW7UK4Z1JNumQ1t"
    #acc_token_secret = input('Enter the Access Token Secret: ')
    acc_token_secret = "HO95gGFL1tUl1Ouo0g0E6Ey6chgclZngdwVv7XrvUoYCr"
